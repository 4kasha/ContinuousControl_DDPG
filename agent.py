...
NUM_UPDATES = 5         # number of update at each step
...
class Agent():
    ...
    def __init__(self, state_size, action_size, seed, hidden_layers, \
                 drop_p, use_bn=True, use_reset=True, noise="gauss", mode="multi"):
        ...
        ======
            ...
            mode (str): if you use a single agent version, set mode="single"
        """
        ...
        self.actor_local = Actor(state_size, action_size, seed, hidden_layers, drop_p, use_bn, use_reset).to(device)
        self.actor_target = Actor(state_size, action_size, seed, hidden_layers, drop_p, use_bn, use_reset).to(device)
        self.actor_optimizer = optim.Adam(self.actor_local.parameters(), lr=LR_ACTOR)

        # Critic Network (w/ Target Network)
        self.critic_local = Critic(state_size, action_size, seed, hidden_layers, use_bn, use_reset).to(device)
        self.critic_target = Critic(state_size, action_size, seed, hidden_layers, use_bn, use_reset).to(device)
